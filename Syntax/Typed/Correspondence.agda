module Syntax.Typed.Correspondence where
...
factor (⟶compRec₁ {s = s} {n = n} rx sd nd) |
  ...
  record
    ...
    ; teq = cong₃ Rec teq (null-lsub' sd) (null-lsub' nd)
    ; seq = cong₃ Rec seq (null-lsub' sd) (null-lsub' nd)
    ; tyeq = tyeq }
...
factor (⟶compRec₂ {z = z} {n = n} zd rx nd) |
  ...
  record
    ...
    ; teq = cong₃ Rec (null-lsub' zd) teq (null-lsub' nd)
    ; seq = cong₃ Rec (null-lsub' zd) seq (null-lsub' nd)
    ; tyeq = tyeq }
...
factor (⟶compRec₃ {z = z} {s = s} zd sd rx) |
  ...
  record
    ...
    ; teq = cong₃ Rec (null-lsub' zd) (null-lsub' sd) teq
    ; seq = cong₃ Rec (null-lsub' zd) (null-lsub' sd) seq
    ; tyeq = tyeq }
