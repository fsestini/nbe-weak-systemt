...
open import Semantics.Completeness hiding (appLemma)
open import Data.Product renaming (_,_ to _,,_)
open import Data.Empty
open import Data.Nat
open import Relation.Binary.PropositionalEquality hiding ([_])
open import Semantics.Soundness.LogicalRelation
open import Semantics.Soundness.SubLogicalRelation
...
fundamental zZ rel eZero = N-®-Z (∼refl zZ)
fundamental (sS td) rel (eSucc ev) =
  N-®-S (∼refl (sS (⊢sub td (derₛ rel)))) (fundamental td rel ev)
fundamental (rec zd sd td) rel (eRec ev ev₁ ev₂ x) =
  rekk (fundamental zd rel ev) (fundamental sd rel ev₁) (fundamental td rel ev₂) x
